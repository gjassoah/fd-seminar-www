...
- [Gustavo Jasso](https://gustavo.jasso.info) (Lund)
...
The FD Seminar is funded by the [Hausdorff Center for Mathematics](https://www.hcm.uni-bonn.de/) of the [Rheinische Friedrich-Wilhelms-Universität Bonn](https://www.uni-bonn.de/).
...
The source code for the website is available [here](https://github.com/gjassoah/fd-seminar-www).
...
{{< note >}}If you are interested in how we set up our BigBlueButton server, click [here](/diy).{{< /note >}}
...
We have made slight modifications to the web interface to our BigBlueButton instance; the source code is available [here](https://github.com/gjassoah/fd-seminar-greenlight).

...
{{< note >}}
We **strongly recommend** to use the latest version of the following web browsers when joining the FD Seminar:
...
* *On Android:* [Google Chrome](https://www.google.com/chrome/)/Chromium or [Mozilla Firefox](https://www.mozilla.org/en-US/firefox/new/)
{{< /note >}}
